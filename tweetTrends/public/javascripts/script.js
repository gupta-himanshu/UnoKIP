...
angular.module("MyApp", []).controller("MyController", function($scope,$log,$filter) {
	$scope.num=10000;
...
//	$scope.getUserDetails = function(fullDetails) ={
	//	var images = fullDetails.Image.split("~");
//		var names = fullDetails.Name.split("~");
//		var twitterId = fullDetails.TwitterID.split("~");
//		(images,names,twitterId)
//	}
	...
	$scope.details = [
	                  {
	                	  ...
	                	  },
	                	  {
	                	    ...
	                	    "TopicId":"14",
	                	    "Image":"http://event.scaladays.org/dl/photos/Scala%20Days%202015%20speakers/David_Hall.jpeg ~ noImage"
	                	  },
	                	  {
	                	    "Date":"2015-06-09",
	                	    "Time":"14:30",
	                	  ...
	                	  },
	                	  {
	                	    ...
	                	    "Topic":"Function-Passing Style",
	                	    "TopicId":"A New Model for Asynchronous and Distributed Programming",
	                	    "Image":"26"
	                	  },
	                	  {
	                	    "Date":"2015-06-09",
	                	  ...
	                	  },
	                	  {
	                	    ...
	                	    "TwitterID":"noHandle",
	                	    "Name":"Adam Gibson",
	                	    "Topic":"The Future of AI in Scala",
	                	    "TopicId":"and on the JVM",
	                	    "Image":"31"
	                	  },
	                	  {
	                	    "Date":"2015-06-10",
	                	  ...
	                	  },
	                	  {
	                	    ...
	                	    "Time":"13:20",
	                	    "Room":"Berlagezaal",
	                	    "TwitterID":"noHandle ~ @devmage",
	                	    "Name":"Alex Yakushev ~ Andrew Harris",
	                	    "Topic":"Almost Zen: Reflections on Four Years of Scala in Practice",
	                	    "TopicId":"42",
	                	    "Image":"noImage ~ http://event.scaladays.org/dl/photos/Scala%20Days%202015%20speakers/Andrew%20Harris.PNG"
	                	  },
	                	  {
	                	    "Date":"2015-06-10",
	                	    "Time":"13:20",
	                	    ...
	                	    "Topic":"Program Functionally",
	                	    "TopicId":"Execute Imperatively: Peeling abstraction overhead from functional programs",
	                	    "Image":"43"
	                	  },
	                	  {
	                	    "Date":"2015-06-10",
	                	  ...
	                	  },
	                	  {
	                	    ...
	                	    "Topic":"Scala Puzzlers: \"In the Matrix",
	                	    "TopicId":"anything is possible!\"",
	                	    "Image":"53"
	                	  },
	                	  {
	                	    "Date":"2015-06-10",
